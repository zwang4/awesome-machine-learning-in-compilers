...
- <img src="https://img.shields.io/badge/26-pages-green.svg" alt="26-pages" align="top"> [Learning to superoptimize programs](https://www.infosun.fim.uni-passau.de/publications/docs/GGS+17.pdf) - Stefan Ganser, Armin Grösslinger, Norbert Siegmund, Sven Apel, and Christian Lengauer. ACM Transactions on Architecture and Code Optimization (TACO), 2017. 
...
- <img src="https://img.shields.io/badge/12-pages-green.svg" alt="12-pages" align="top"> [Bandit-based optimization on graphs with application to library performance tuning](https://www.icml.cc/Conferences/2009/papers/494.pdf) - Frédéric De Mesmay, Arpad Rimmel, Yevgen Voronenko, and Markus Püschel. ICML 2009.
